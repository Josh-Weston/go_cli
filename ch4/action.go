...
// notice how many steps are required to make it cross-platform, pretty interesting
func archiveFile(destDir, root, path string) error {
	...
	zw.Name = filepath.Base(path) // store the source file name in the compressed file
